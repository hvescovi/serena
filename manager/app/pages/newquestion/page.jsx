...
export default function Questions() {
  ...
  const addQuestion = async () => {
    ...
    let { enunciado, type, resposta, observacao, ativa } = form;
    let dados;
    ...
    if (type === "aberta") {
      ...
      //  alert("Processando alternativa: " + alt);
      //}
      ...
      alternativas.forEach(alt => {
        if (alt.substring(0, 7) === "(CERTA)") {
          alt = alt.substring(7); // remove the "(CERTA)" prefix
        ...
        >
          ...
          <div>
            ...
            <Editor
              ...
              onTextChange={(e) => setForm({ ...form, enunciado: e.htmlValue || "" })}
          ...
          <div>
            ...
            <Editor
              value={form.resposta}
              onTextChange={(e) => setForm({ ...form, resposta: e.htmlValue || "" })}
            ...
            <form onSubmit={updateQuestion} className="flex flex-col gap-4">
              ...
              <div>
                ...
                <Editor
                  ...
                  onTextChange={(e) => setEditForm({ ...editForm, resposta: e.htmlValue || "" })}
                  placeholder="Digite a resposta (se aplicável)"
                  style={{ height: '200px' }}
                  className="w-full"
                />
